...
// src/angular/index.ts
var _reset_dec, _requestRegenImage_dec, _requestImage_dec, _slideChange_dec, _save_dec, _change_dec, _ready_dec, _autoSaveMs_dec, _foot_dec, _transition_dec, _theme_dec, _edit_dec, _deck_dec, _hostRef_dec, _DeckViewerComponent_decorators, _init;
_DeckViewerComponent_decorators = [(0, import_core.Component)({
  selector: "edm-deck",
  standalone: true,
...
})], _hostRef_dec = [(0, import_core.ViewChild)("host", { static: true })], _deck_dec = [(0, import_core.Input)({ required: true })], _edit_dec = [(0, import_core.Input)()], _theme_dec = [(0, import_core.Input)()], _transition_dec = [(0, import_core.Input)()], _foot_dec = [(0, import_core.Input)()], _autoSaveMs_dec = [(0, import_core.Input)()], _ready_dec = [(0, import_core.Output)()], _change_dec = [(0, import_core.Output)()], _save_dec = [(0, import_core.Output)()], _slideChange_dec = [(0, import_core.Output)()], _requestImage_dec = [(0, import_core.Output)()], _requestRegenImage_dec = [(0, import_core.Output)()], _reset_dec = [(0, import_core.Output)()];
var DeckViewerComponent = class {
  constructor() {
    this.hostRef = __runInitializers(_init, 8, this), __runInitializers(_init, 11, this);
    this.deck = __runInitializers(_init, 12, this), __runInitializers(_init, 15, this);
    this.edit = __runInitializers(_init, 16, this, false), __runInitializers(_init, 19, this);
    this.theme = __runInitializers(_init, 20, this), __runInitializers(_init, 23, this);
    this.transition = __runInitializers(_init, 24, this), __runInitializers(_init, 27, this);
    this.foot = __runInitializers(_init, 28, this), __runInitializers(_init, 31, this);
    this.autoSaveMs = __runInitializers(_init, 32, this, 1200), __runInitializers(_init, 35, this);
    this.ready = __runInitializers(_init, 36, this, new import_core.EventEmitter()), __runInitializers(_init, 39, this);
    this.change = __runInitializers(_init, 40, this, new import_core.EventEmitter()), __runInitializers(_init, 43, this);
    this.save = __runInitializers(_init, 44, this, new import_core.EventEmitter()), __runInitializers(_init, 47, this);
    this.slideChange = __runInitializers(_init, 48, this, new import_core.EventEmitter()), __runInitializers(_init, 51, this);
    this.requestImage = __runInitializers(_init, 52, this, new import_core.EventEmitter()), __runInitializers(_init, 55, this);
    this.requestRegenImage = __runInitializers(_init, 56, this, new import_core.EventEmitter()), __runInitializers(_init, 59, this);
    this.reset = __runInitializers(_init, 60, this, new import_core.EventEmitter()), __runInitializers(_init, 63, this);
    this.handle = null;
  }
...
__decorateElement(_init, 5, "hostRef", _hostRef_dec, DeckViewerComponent);
__decorateElement(_init, 5, "deck", _deck_dec, DeckViewerComponent);
__decorateElement(_init, 5, "edit", _edit_dec, DeckViewerComponent);
__decorateElement(_init, 5, "theme", _theme_dec, DeckViewerComponent);
__decorateElement(_init, 5, "transition", _transition_dec, DeckViewerComponent);
__decorateElement(_init, 5, "foot", _foot_dec, DeckViewerComponent);
__decorateElement(_init, 5, "autoSaveMs", _autoSaveMs_dec, DeckViewerComponent);
__decorateElement(_init, 5, "ready", _ready_dec, DeckViewerComponent);
__decorateElement(_init, 5, "change", _change_dec, DeckViewerComponent);
__decorateElement(_init, 5, "save", _save_dec, DeckViewerComponent);
__decorateElement(_init, 5, "slideChange", _slideChange_dec, DeckViewerComponent);
__decorateElement(_init, 5, "requestImage", _requestImage_dec, DeckViewerComponent);
__decorateElement(_init, 5, "requestRegenImage", _requestRegenImage_dec, DeckViewerComponent);
__decorateElement(_init, 5, "reset", _reset_dec, DeckViewerComponent);
DeckViewerComponent = __decorateElement(_init, 0, "DeckViewerComponent", _DeckViewerComponent_decorators, DeckViewerComponent);
__runInitializers(_init, 1, DeckViewerComponent);
