...
__export(src_exports, {
  ...
  SELECTABLE_LAYOUTS: () => SELECTABLE_LAYOUTS,
  THEMES: () => THEMES,
  THEME_BY_KEY: () => THEME_BY_KEY,
  applyDisplay: () => applyDisplay,
  applyTheme: () => applyTheme,
  attachLegacyPlayer: () => attachLegacyPlayer,
  attachPlayer: () => attachPlayer,
  bulletsToColumns: () => bulletsToColumns,
  canConvert: () => canConvert,
  columnsToBullets: () => columnsToBullets,
  convert: () => convert,
  deckCss: () => deckCss,
  diffDeck: () => diffDeck,
  escRich: () => escRich,
  ...
  renderEditChrome: () => renderEditChrome,
...
function attachLegacyPlayer(w = 1280, h = 720) {
  ...
  try {
    parent.postMessage({ lpReady: true, count: p.count() }, "*");
  } catch {
  }
  ;
  window.__deck = { show: p.show, fit: p.fit, cur: p.cur, refresh: p.refresh };
  return p;
}
